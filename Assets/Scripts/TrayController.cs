...
public class TrayController : MonoBehaviour
{
    ...
    //        dish.transform.rotation = lastDish.transform.rotation;
    //        dish.Rigidbody.velocity = lastDish.Rigidbody.velocity;
    //        dish.Rigidbody.angularVelocity = lastDish.Rigidbody.angularVelocity;
